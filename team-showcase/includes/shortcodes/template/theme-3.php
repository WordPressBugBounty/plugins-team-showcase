...
?>
	...
	<div class="tmf-wrapper <?php echo esc_attr( $team_manager_free_post_themes ); ?>" data-style="<?php echo esc_attr( $team_manager_free_post_themes ); ?>"
     style="
        ...
        --tmf-overlay-background: <?php echo esc_attr($team_manager_free_overlay_bg_color); ?>;
						...
						<div class="team-manager-free-items">
					        <div class="team-manager-free-items-thumbnail">
					            ...
					            <div class="team-overlay">
					                <a href="#team-popup-area-<?php echo esc_attr( $random_team_id ); ?>" class="open-popup-link pic-bottom team-plus" data-effect="mfp-zoom-in">+</a>
					            </div>
					        </div>

							<div class="team-manager-free-items-profiles">
								<h3 class="tmf-member-title">
